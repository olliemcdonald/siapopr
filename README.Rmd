...
`compile_custom_fitness(cppfile)` which creates the necessary header, compiles, and
builds a shared library out of the distribution function file so that SIApop can
