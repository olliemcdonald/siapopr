...
// siapopConstant
int siapopConstant(double tot_life, int max_pop, double start_time, int ancestors, int ancestor_clones, int num_sims, bool allow_extinction, bool is_custom_model, int num_samples, int sample_size, double detection_threshold, double observation_frequency, SEXP observation_times, double birth_rate, double death_rate, double mutation_prob, double alpha_fitness, double beta_fitness, double pass_prob, double upper_fitness, double lower_fitness, double alpha_mutation, double beta_mutation, bool trace_ancestry, bool count_alleles, double punctuated_prob, double poisson_param, double punctuated_multiplier, double punctuated_advantageous_prob, double epistatic_mutation_thresh, double epistatic_multiplier, SEXP input_file, SEXP output_dir, SEXP ancestor_file);
RcppExport SEXP siapopr_siapopConstant(SEXP tot_lifeSEXP, SEXP max_popSEXP, SEXP start_timeSEXP, SEXP ancestorsSEXP, SEXP ancestor_clonesSEXP, SEXP num_simsSEXP, SEXP allow_extinctionSEXP, SEXP is_custom_modelSEXP, SEXP num_samplesSEXP, SEXP sample_sizeSEXP, SEXP detection_thresholdSEXP, SEXP observation_frequencySEXP, SEXP observation_timesSEXP, SEXP birth_rateSEXP, SEXP death_rateSEXP, SEXP mutation_probSEXP, SEXP alpha_fitnessSEXP, SEXP beta_fitnessSEXP, SEXP pass_probSEXP, SEXP upper_fitnessSEXP, SEXP lower_fitnessSEXP, SEXP alpha_mutationSEXP, SEXP beta_mutationSEXP, SEXP trace_ancestrySEXP, SEXP count_allelesSEXP, SEXP punctuated_probSEXP, SEXP poisson_paramSEXP, SEXP punctuated_multiplierSEXP, SEXP punctuated_advantageous_probSEXP, SEXP epistatic_mutation_threshSEXP, SEXP epistatic_multiplierSEXP, SEXP input_fileSEXP, SEXP output_dirSEXP, SEXP ancestor_fileSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(siapopConstant(tot_life, max_pop, start_time, ancestors, ancestor_clones, num_sims, allow_extinction, is_custom_model, num_samples, sample_size, detection_threshold, observation_frequency, observation_times, birth_rate, death_rate, mutation_prob, alpha_fitness, beta_fitness, pass_prob, upper_fitness, lower_fitness, alpha_mutation, beta_mutation, trace_ancestry, count_alleles, punctuated_prob, poisson_param, punctuated_multiplier, punctuated_advantageous_prob, epistatic_mutation_thresh, epistatic_multiplier, input_file, output_dir, ancestor_file));
    return rcpp_result_gen;
END_RCPP
}
// siapopSimple
int siapopSimple(double tot_life, int ancestors, int ancestor_clones, int num_sims, int num_samples, int sample_size, bool allow_extinction, double detection_threshold, double birth_rate, double death_rate, SEXP input_file, SEXP output_dir, SEXP ancestor_file);
RcppExport SEXP siapopr_siapopSimple(SEXP tot_lifeSEXP, SEXP ancestorsSEXP, SEXP ancestor_clonesSEXP, SEXP num_simsSEXP, SEXP num_samplesSEXP, SEXP sample_sizeSEXP, SEXP allow_extinctionSEXP, SEXP detection_thresholdSEXP, SEXP birth_rateSEXP, SEXP death_rateSEXP, SEXP input_fileSEXP, SEXP output_dirSEXP, SEXP ancestor_fileSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type tot_life(tot_lifeSEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type output_dir(output_dirSEXP);
    Rcpp::traits::input_parameter< SEXP >::type ancestor_file(ancestor_fileSEXP);
    rcpp_result_gen = Rcpp::wrap(siapopSimple(tot_life, ancestors, ancestor_clones, num_sims, num_samples, sample_size, allow_extinction, detection_threshold, birth_rate, death_rate, input_file, output_dir, ancestor_file));
    return rcpp_result_gen;
END_RCPP
}
// siapopTimeDep
int siapopTimeDep(double tot_life, int max_pop, double start_time, int ancestors, int ancestor_clones, int num_sims, bool allow_extinction, bool is_custom_model, int num_samples, int sample_size, double detection_threshold, double observation_frequency, SEXP observation_times, int birth_function, Rcpp::NumericVector birth_coefs, int death_function, Rcpp::NumericVector death_coefs, double mutation_prob, double alpha_fitness, double beta_fitness, double pass_prob, double upper_fitness, double lower_fitness, double alpha_mutation, double beta_mutation, bool trace_ancestry, bool count_alleles, double punctuated_prob, double poisson_param, double punctuated_multiplier, double punctuated_advantageous_prob, double epistatic_mutation_thresh, double epistatic_multiplier, SEXP input_file, SEXP output_dir, SEXP ancestor_file);
RcppExport SEXP siapopr_siapopTimeDep(SEXP tot_lifeSEXP, SEXP max_popSEXP, SEXP start_timeSEXP, SEXP ancestorsSEXP, SEXP ancestor_clonesSEXP, SEXP num_simsSEXP, SEXP allow_extinctionSEXP, SEXP is_custom_modelSEXP, SEXP num_samplesSEXP, SEXP sample_sizeSEXP, SEXP detection_thresholdSEXP, SEXP observation_frequencySEXP, SEXP observation_timesSEXP, SEXP birth_functionSEXP, SEXP birth_coefsSEXP, SEXP death_functionSEXP, SEXP death_coefsSEXP, SEXP mutation_probSEXP, SEXP alpha_fitnessSEXP, SEXP beta_fitnessSEXP, SEXP pass_probSEXP, SEXP upper_fitnessSEXP, SEXP lower_fitnessSEXP, SEXP alpha_mutationSEXP, SEXP beta_mutationSEXP, SEXP trace_ancestrySEXP, SEXP count_allelesSEXP, SEXP punctuated_probSEXP, SEXP poisson_paramSEXP, SEXP punctuated_multiplierSEXP, SEXP punctuated_advantageous_probSEXP, SEXP epistatic_mutation_threshSEXP, SEXP epistatic_multiplierSEXP, SEXP input_fileSEXP, SEXP output_dirSEXP, SEXP ancestor_fileSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type tot_life(tot_lifeSEXP);
    ...
    Rcpp::traits::input_parameter< SEXP >::type output_dir(output_dirSEXP);
    Rcpp::traits::input_parameter< SEXP >::type ancestor_file(ancestor_fileSEXP);
    rcpp_result_gen = Rcpp::wrap(siapopTimeDep(tot_life, max_pop, start_time, ancestors, ancestor_clones, num_sims, allow_extinction, is_custom_model, num_samples, sample_size, detection_threshold, observation_frequency, observation_times, birth_function, birth_coefs, death_function, death_coefs, mutation_prob, alpha_fitness, beta_fitness, pass_prob, upper_fitness, lower_fitness, alpha_mutation, beta_mutation, trace_ancestry, count_alleles, punctuated_prob, poisson_param, punctuated_multiplier, punctuated_advantageous_prob, epistatic_mutation_thresh, epistatic_multiplier, input_file, output_dir, ancestor_file));
    return rcpp_result_gen;
END_RCPP
}
